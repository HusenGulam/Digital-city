...
function TeamSection() {
  ...
  useEffect(() => {
    async function getHomeDate() {
      try {
        const response = await fetch("http://10.10.11.17:8001/testimonial/")
  ...
  return (
    <div>
      <section className='team_section'>
          <div className="team_section_content">
          <h2 className='team_section_title' data-aos="fade-top">Delivering real results for top companies. Some of our success stories.</h2>
          </div>

    <div className="team_section_box_row">
      {
        teamDate.map((item) => (
          <div className='team_members' key={item.id} data-aos="flip-left">
            <q>{item.text}</q> <br />
              <b>{item.name}</b>
            <div className='members_img'>
              <img src={item.photo} alt={`${item.name}'s photo` } style={{"width":"70px","borderRadius":"50%"}} />
            </div>
            <div className='team_member_info'>
            <div class="card">
  <Link class="socialContainer containerOne" href="https://www.instagram.com/digitalcityuz/" target="_blank">
  ...
  <Link class="socialContainer containerTwo" href="https://twitter.com/?lang=ru" target="_blank">
  ...
  <Link class="socialContainer containerThree" href="https://uz.linkedin.com/" target="_blank">
  ...
  <Link class="socialContainer containerFour" href="https://web.whatsapp.com/" target="_blank">
