...
import dcImg from './img/proect-title.png'
    ...
    <>
      <footer>
       ...
       <div className="footer_title_box">
            <Image src={dcImg} style={{ width: "150px", height: '150px' }} className="footer_title" />
            <Link href={'/'} className='btn-shine'>home</Link>
            <Link href={'/about'} className='btn-shine'>about</Link>
        </div>

        <div className="footer_description">
            <p>987  Hillcrest LaneIrvine, <br />
            Address: Andijan region, <br /> Boburshokh street 2A house <br />
            Contact phone number is 1227</p>
        </div>
        </div>  
